...
export function execute(expression, dataContext = {}, magicContext = {}) {
    ...
    // Figured out why it's not binding! Anonymous functions can't have 'this' bound to them, and I've generally been defining an object full of anonymous functions. If I just switch them to the standard 'function' syntax it should be good!
    ...
    let func = new AsyncFunction(['__self', 'scope', 'magic'], 
        `
        with (magic) { 
            with (scope) {
